...
python evals/self_test.py                       # 39 個樣本，每個都必須落在它該落的 check id
python evals/mutation_test.py                   # 28 個突變體，證明每條規則真的是抓到它的那一條
