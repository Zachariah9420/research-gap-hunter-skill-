...
> 相對於 good_report.md，本檔刻意壞掉一處：〔印象，未驗證〕從 A3 那一行被拿掉，而這一行註記裡還留著〔印象，未驗證〕這幾個字——所以「文件裡有沒有這個標籤」的答案仍然是有，只有「它在不在那一條的那一行上」問得出問題。效力是讀者唯一看得到的東西，掛在別的地方等於沒掛。
...
- 預設 A3：〈居民願意步行前往公園的距離上限大約是 500 公尺〉——摘要層精讀只有 2 篇（M′ < 3），不得作為 G3 輸入
