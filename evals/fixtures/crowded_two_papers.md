...
| C10 建立綠地暴露與身體活動的劑量—反應曲線 | CROWDED | 三篇分別涵蓋本候選的三個子問題：暴露的量化方式（Author E）、劑量—反應函數的形狀（Author F）、跨城市泛化（Author G）；逐一比對後沒有剩餘的未涵蓋子問題，故非 ADJACENT。 | Author E et al. (2022)；Author F et al. (2023) | DOI:10.5555/synthetic-0004；DOI:10.5555/synthetic-0005；DOI:10.5555/synthetic-0006 | 期刊、會議、期刊 | 已查，Crossref 無記錄 |
