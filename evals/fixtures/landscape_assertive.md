...
> 相對於 good_landscape.md，本檔刻意壞掉一處：第三節把「本次檢索沒有回傳」寫成斷言。措辭規則在兩種模式都成立，這一份就是釘住它在地形報告裡也有效。
...
2. **F5 ＋ F4**：用軌跡量到訪、用問卷補動機與感受。軌跡負責「去了沒」，問卷負責「為什麼去」，兩邊的樣本必須是同一批人，成本落在資料授權與倫理審查，通常比方法本身貴；這種疊法沒有人做過。
