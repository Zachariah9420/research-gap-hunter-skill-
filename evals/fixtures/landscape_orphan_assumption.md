...
> 相對於 good_landscape.md，本檔刻意壞掉一處：W3 少收了 F6-a，那條預設在第二節寫下來之後就從第六節消失了，接手的缺口獵捕拿不到它。
...
| W3 | 量測到的那個時點或那一段，可以代表更長的期間 | F1-b | 1 | 真的必要 | 這兩個家族的資料本身就是離散取樣，取消取樣點等於取消這個家族；能改的是取樣密度與如何標示不確定性，不是這條預設本身 |
