...
> 相對於 good_landscape.md，本檔刻意壞掉一處：第三節混進一個缺口獵捕才有的判定詞彙，地形圖悄悄變成一份沒有付舉證成本的判決。
...
1. **F1 ＋ F2**：先用遙測算出全市的綠量，再用圖資把「進得去的綠」切出來。前者給覆蓋、後者給可及性，成本仍然接近零，代價是兩層都不知道誰真的去了。這是政策報告最常見的組合，這個方向已經 CROWDED，不值得再投入。
