...
- **最接近的既有研究**：Author C et al. (2023)〈Residential greenness and moderate-to-vigorous physical activity in adults〉。差異維度是暴露變項的操作化：該研究以住家 500 公尺緩衝區的綠覆率當暴露量，本候選以居民實際到訪公園的頻率與停留時間當暴露量；住得近不等於走得進去，若兩種暴露量測給出的關聯強度差距明顯，就代表既有估計量到的是可及性而不是使用，這是可被否證的預測。
