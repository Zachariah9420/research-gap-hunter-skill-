...
|---|---|---|---|---|---|---|
| C07 以住家到最近公園的距離預測居民身體活動量 | DONE | 摘要逐字引句：「Using distance from home to the nearest public park, we find that each additional 100 metres is associated with 3.4 fewer minutes of weekly moderate-to-vigorous physical activity among 5,200 urban adults.」母體、自變項、結果變項、研究設計四項全中。 |  | DOI:10.5555/synthetic-0003 | 期刊 | 已查，Crossref 無記錄 |
